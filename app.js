...
const INITIAL_LETTERS = [
  {
    ...
    content: "Yomira, desde que llegaste a mi vida, cada día se siente como Navidad. Eres el regalo que nunca esperé pero que siempre necesité. Tu sonrisa ilumina más que cualquier árbol navideño.",
    date: "24 Dic 2024",
    category: "christmas"
  },
  {
    ...
    content: "No hay palabras suficientes en el diccionario para describir cuánto te amo. Eres mi refugio, mi paz y mi mayor alegría. Gracias por ser tú, Yomira.",
    date: "Eternamente",
    category: "romantic"
  },
  {
...
const ROMANTIC_PHRASES = [
  "Yomira, eres la razón de mis sonrisas.",
  ...
  "Yomira + Yo = Para siempre."
];

const MEMORIES = [
  { id: 1, imageUrl: "https://i.pinimg.com/736x/b5/2a/2d/b52a2da596832039accad43741a5839f.jpg", caption: "Nuestros momentos mágicos" },
  { id: 2, imageUrl: "https://i.pinimg.com/1200x/87/ed/01/87ed019cfc54ad30c1cb8c4b2c8ca2d1.jpg", caption: "Tu risa que lo cura todo" },
  { id: 3, imageUrl: "https://i.pinimg.com/736x/8c/e2/dc/8ce2dc4a93a88ef4755e6f2ddafa8fdf.jpg", caption: "Caminando juntos de la mano" },
  { id: 4, imageUrl: "https://i.pinimg.com/736x/c8/87/59/c887594006592cb6522e609674556ebe.jpg" },
];
        ...
        <div class="letter-inner">
          <div class="letter-front">
            ...
            <div>
              ...
              <p class="letter-to">Para Yomira</p>
            </div>
...
function initGift() {
  ...
  if (acceptBtn) {
    acceptBtn.addEventListener("click", () => {
      alert("💖 ¡Confirmado! Yomira y su novio serán felices para siempre.");
    });
  }
}
